# -*- coding: utf-8 -*-
"""
Created on Sat Apr 25 15:48:29 2020
...
if __name__ == "__main__":
    T = weather_data(city="guangzhou",start_year=2015,end_year=2020,start_month=1,end_month=4)
...
fin.to_csv('广州气象.csv',encoding="utf_8_sig")  
