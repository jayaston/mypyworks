...
#a3[:,1]
#注意此处可能因为没有指标而报错。待后续用apply修复
sorted_data = sorted_data.assign(开发区东4 = sorted_data['天河开发区路口DN600正向累计'],
                   开发区东7 = sorted_data['姬堂村A表累计流量'] + sorted_data['姬堂村B表累计流量'],     
                 开发区东8 = sorted_data['科学城雕塑正向累计'] + sorted_data['宏仁电子厂门口(0017988650)累计流量'],
                 开发区东9 = sorted_data['开发区西区累计流量1'] + sorted_data['开发区西区累计流量2'] + sorted_data['萝岗开发区供水中心DN400累计'] - sorted_data['萝岗开发区供水中心DN400反向累计'] + sorted_data['开发区北面累计'],
                 开发区东10 = sorted_data['新新大道与永安大道交界DN1200累计'],
                 #开发区北区 = sorted_data['天鹿北路累计'] - sorted_data['天鹿北路反向累计'],
                 花都北1 = sorted_data['太成村正向累计流量'] + sorted_data['花都迎宾大道正向累计'],
                 花都北2 = sorted_data['云山大道正向累计'] + sorted_data['雅遥正向累计流量'] + sorted_data['越堡水泥公司DN1400正向累计'],
                 #开发区东区 = sorted_data['开发区'] - sorted_data['开发区北区'],
                 )
...
sorted_data = sorted_data.reindex(columns=['取水量_广州自来水公司','入厂取水量_新塘水厂', '入厂取水量_江村水厂', '入厂取水量_石门水厂', '入厂取水量_西村水厂', '入厂取水量_西洲水厂','入厂取水量_北部水厂', '入厂取水量_南洲水厂',
    '水厂供水总量_广州自来水公司','水厂供水总量_西村水厂', '水厂供水总量_石门水厂', '水厂供水总量_江村水厂', '水厂供水总量_新塘水厂', '水厂供水总量_西洲水厂', '水厂供水总量_南洲水厂', '水厂供水总量_北部水厂',
    '中区', '东区','南区', '北区', '开发区东区', '南9（黄岐）','花都','开发区北区','人和', '穗云',
    ...
    '最高温','最低温','平均温',
    '开发区东4','开发区东7','开发区东8','开发区东9','开发区东10','开发区北4','花都北1','花都北2',])
 
#sorted_data.drop('太和镇',axis=1,inplace=True)
