...
list1 = [['00','00718','d'],
         ...
         ['1007','00718','d'],
         ['1016','00718','d']]
shuju_df = sj.Datataizhang().getdata('20090101','20190701',list1)
...
shuju_maxgszl = shuju_gszl.sort_values(by='QUOTA_VALUE',ascending=False)[['QUOTA_DATE','QUOTA_VALUE','QUOTA_NAME']]
